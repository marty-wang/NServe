(function() {
  ...
  */
  ...
  _init = function() {
    var dataTransferer, fileTransferer, hooks, lg, liveScriptPath, ws;
    _server = connect();
    hooks = [];
