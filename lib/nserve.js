(function() {
  var DEFAULT_PORT, colors, connect, fileTransfer, fs, http, parse, program, start, sys, time, util, versioning, _fileTransferCallback, _init, _isVerbose, _now, _parseCLI, _port, _rate, _root, _router, _server, _version, _versionNumber;
  DEFAULT_PORT = 3000;
  sys = require("sys");
  fs = require("fs");
  http = require("http");
