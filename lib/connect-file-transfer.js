(function() {
  var FileTransferer, async, fileDeliver, fs, mime, parse, transfer, _callback, _cb, _fileTransferer, _root, _transfer;
  ...
  FileTransferer = (function() {
    ...
    function FileTransferer(fileDeliverer, dataTransferer, hooks) {
      if (hooks == null) hooks = [];
      this._deliverer = fileDeliverer;
    ...
    FileTransferer.prototype.transfer = function(filepath, callback) {
      var _this = this;
      return this._deliverer.deliver(filepath, function(err, payload) {
  ...
  */
  ...
  transfer = function(transferer, root, callback, hooks) {
    var deliverer;
    if (hooks == null) hooks = [];
    _root = root;
    _callback = callback;
